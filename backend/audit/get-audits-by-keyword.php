...
try {
    ...
    Audit_Users_History_ID IS NULL AND
    (Audit_timestamp LIKE "%":keyword"%" OR
    Audit_username LIKE "%":keyword"%" OR
    Audit_action LIKE "%":keyword"%" OR
    Audit_search_term LIKE "%":keyword"%")
    ORDER BY Audit_timestamp DESC LIMIT :limit');
    $query->bindValue('limit', $limit, PDO::PARAM_INT);
    $query->bindValue('keyword', $_GET['keyword']);
    $query->execute();
    ...
    WHERE Audit_timestamp LIKE "%":keyword"%" OR
    Audit_username LIKE "%":keyword"%" OR
    Audit_action LIKE "%":keyword"%" OR
    Audit_People_old_name LIKE "%":keyword"%" OR
    Audit_People_old_address LIKE "%":keyword"%" OR
    Audit_People_old_licence LIKE "%":keyword"%" OR
    Audit_People_new_name LIKE "%":keyword"%" OR
    Audit_People_new_address LIKE "%":keyword"%" OR
    Audit_People_new_licence LIKE "%":keyword"%" 
    ORDER BY Audit_timestamp DESC LIMIT :limit');
    $query->bindValue('limit', $limit, PDO::PARAM_INT);
    $query->bindValue('keyword', $_GET['keyword']);
    $query->execute();
    ...
    Audit_username LIKE "%":keyword"%" OR
    Audit_action LIKE "%":keyword"%" OR
    Audit_Vehicle_old_make LIKE "%":keyword"%" OR
    Audit_Vehicle_old_model LIKE "%":keyword"%" OR
    Audit_Vehicle_old_colour LIKE "%":keyword"%" OR
    Audit_Vehicle_old_licence LIKE "%":keyword"%" OR
    Audit_Vehicle_new_make LIKE "%":keyword"%" OR
    Audit_Vehicle_new_model LIKE "%":keyword"%" OR
    Audit_Vehicle_new_colour LIKE "%":keyword"%" OR
    Audit_Vehicle_new_licence LIKE "%":keyword"%"
    ORDER BY Audit_timestamp DESC LIMIT :limit');
    $query->bindValue('limit', $limit, PDO::PARAM_INT);
    $query->bindValue('keyword', $_GET['keyword']);
    $query->execute();
    ...
    Audit_username LIKE "%":keyword"%" OR
    Audit_action LIKE "%":keyword"%" OR
    Audit_Incident_old_vehicle_ID LIKE "%":keyword"%" OR
    Audit_Incident_old_people_ID LIKE "%":keyword"%" OR
    Audit_Incident_old_date LIKE "%":keyword"%" OR
    Audit_Incident_old_report LIKE "%":keyword"%" OR
    Audit_Incident_old_offence_ID LIKE "%":keyword"%" OR
    Audit_Incident_new_vehicle_ID LIKE "%":keyword"%" OR
    Audit_Incident_new_people_ID LIKE "%":keyword"%" OR
    Audit_Incident_new_date LIKE "%":keyword"%" OR
    Audit_Incident_new_report LIKE "%":keyword"%" OR
    Audit_Incident_new_offence_ID LIKE "%":keyword"%"
    ORDER BY Audit_timestamp DESC LIMIT :limit');
    $query->bindValue('limit', $limit, PDO::PARAM_INT);
    $query->bindValue('keyword', $_GET['keyword']);
    $query->execute();
    ...
    Audit_username LIKE "%":keyword"%" OR
    Audit_action LIKE "%":keyword"%" OR
    Audit_Fines_old_amount LIKE "%":keyword"%" OR
    Audit_Fines_old_points LIKE "%":keyword"%" OR
    Audit_Fines_new_amount LIKE "%":keyword"%" OR
    Audit_Fines_new_points LIKE "%":keyword"%"
    ORDER BY Audit_timestamp DESC LIMIT :limit');
    $query->bindValue('limit', $limit, PDO::PARAM_INT);
    $query->bindValue('keyword', $_GET['keyword']);
    $query->execute();
    ...
    Audit_username LIKE "%":keyword"%" OR
    Audit_action LIKE "%":keyword"%" OR
    Audit_Users_old_username LIKE "%":keyword"%" OR
    Audit_Users_old_password LIKE "%":keyword"%" OR
    Audit_Users_old_admin LIKE "%":keyword"%" OR
    Audit_Users_new_username LIKE "%":keyword"%" OR
    Audit_Users_new_password LIKE "%":keyword"%" OR
    Audit_Users_new_admin LIKE "%":keyword"%"
    ORDER BY Audit_timestamp DESC LIMIT :limit');
    $query->bindValue('limit', $limit, PDO::PARAM_INT);
    $query->bindValue('keyword', $_GET['keyword']);
    $query->execute();
